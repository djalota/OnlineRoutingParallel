...
%lambda_tot = [4.2, 7.125, 9.5, 10, 9.5 ; 5.25, 9.5, 10, 9.8, 9.5];
%lambda_tot = [4.2, 7.125, 9.5, 10, 9.5; 5.25, 5.25, 5.25, 5.25, 5.25; 5.25, 7.125, 5.25, 7.125, 5.25; 5.25, 12, 5.25, 12, 5.25; 5.25, 12, 5.25, 9, 5.25; 5.25, 9, 5.25, 12, 5.25];
%lambda_tot = [4.2, 5.25, 6.5, 7.125, 6.5];
%lambda_tot = [3, 5.25, 6, 6.5, 6];
%lambda_tot = [5.25, 9, 5.25, 12, 5.25];
%lambda_tot = [3, 5.25, 6.5, 7.125, 6.5; 5.25, 5.25, 5.25, 5.25, 5.25; 5.25, 7.125, 5.25, 7.125, 5.25; 5.25, 6.5, 5.25, 6.5, 5.25; 5.25, 6.5, 5.25, 7.125, 5.25; 5.25, 7.125, 5.25, 6.5, 5.25];
lambda_tot = [3.375, 5.25, 6.5, 7.125, 6.5; 5.25, 5.25, 5.25, 5.25, 5.25; 5.25, 7.125, 5.25, 7.125, 5.25; 5.25, 6.5, 5.25, 6.5, 5.25; 5.25, 6.5, 5.25, 7.125, 5.25; 5.25, 7.125, 5.25, 6.5, 5.25];
...
%                 disp(spt_index2);
    ...
    for instance = K/2:K
        ...
        for person_val = 1:N
            ...
            elseif time_arrival_glob(instance, time_arrival) <= 28
            ...
            elseif time_arrival_glob(instance, time_arrival) <= 42
            ...
            elseif time_arrival_glob(instance, time_arrival) <= 56
...
ylabel('Percent Violation')
ylim([0, 0.6])
matlab2tikz('Trial2TheoryBounds.tex');
%title('Scenario')
...
hold off
legend('Greedy', 'Scenario', 'Scenario Time')
xlabel('Competitive Ratio')
ylabel('Count')
title('Real Scenario 1')

subplot(3,2,2);
histogram(greedy_comp_dist(2, :), 10, 'FaceAlpha',0.2)
hold on
histogram(comp_ratio_vals_dist(2, :), 10, 'facecolor', [0.3 0.5 0.2], 'FaceAlpha',0.4)
histogram(comp_ratio_vals_new_dist(2, :), 10, 'facecolor', [0.7 0.1 0.1], 'FaceAlpha',0.4)
hold off
legend('Greedy', 'Scenario', 'Scenario Time')
xlabel('Competitive Ratio')
ylabel('Count')
title('Real Scenario 2')

subplot(3,2,3);
histogram(greedy_comp_dist(3, :), 10, 'FaceAlpha',0.2)
hold on
histogram(comp_ratio_vals_dist(3, :), 10, 'facecolor', [0.3 0.5 0.2], 'FaceAlpha',0.4)
histogram(comp_ratio_vals_new_dist(3, :), 10, 'facecolor', [0.7 0.1 0.1], 'FaceAlpha',0.4)
hold off
legend('Greedy', 'Scenario', 'Scenario Time')
xlabel('Competitive Ratio')
ylabel('Count')
...
subplot(3,2,4);
histogram(greedy_comp_dist(4, :), 10, 'FaceAlpha',0.2)
hold on
histogram(comp_ratio_vals_dist(4, :), 10, 'facecolor', [0.3 0.5 0.2], 'FaceAlpha',0.4)
histogram(comp_ratio_vals_new_dist(4, :), 10, 'facecolor', [0.7 0.1 0.1], 'FaceAlpha',0.4)
hold off
legend('Greedy', 'Scenario', 'Scenario Time')
xlabel('Competitive Ratio')
ylabel('Count')
...
subplot(3,2,5);
histogram(greedy_comp_dist(5, :), 10, 'FaceAlpha',0.2)
hold on
histogram(comp_ratio_vals_dist(5, :), 10, 'facecolor', [0.3 0.5 0.2], 'FaceAlpha',0.4)
histogram(comp_ratio_vals_new_dist(5, :), 10, 'facecolor', [0.7 0.1 0.1], 'FaceAlpha',0.4)
hold off
legend('Greedy', 'Scenario', 'Scenario Time')
xlabel('Competitive Ratio')
ylabel('Count')
...
subplot(3,2,6);
histogram(greedy_comp_dist(6, :), 10, 'FaceAlpha',0.2)
hold on
histogram(comp_ratio_vals_dist(6, :), 10, 'facecolor', [0.3 0.5 0.2], 'FaceAlpha',0.4)
histogram(comp_ratio_vals_new_dist(6, :), 10, 'facecolor', [0.7 0.1 0.1], 'FaceAlpha',0.4)
hold off
legend('Greedy', 'Scenario', 'Scenario Time')
xlabel('Competitive Ratio')
ylabel('Count')
...
%matlab2tikz('Trial2Histogram.tex');
